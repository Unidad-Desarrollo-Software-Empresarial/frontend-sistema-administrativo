          ...
          <div class="p-4 overflow-y-auto">
            <ul>
              <li v-for="categoria in categoriasFiltradas" :key="categoria.nombre" class="mb-4">
                <div class="flex items-center justify-between cursor-pointer" @click="categoria.expandido = !categoria.expandido">
                ...
                <ul v-if="categoria.expandido" class="mt-2 ml-4">
                  <li v-for="competencia in categoria.competencias" :key="competencia" class="pl-2 py-1 border-b flex justify-between items-center">
                    {{ competencia }}
                    <button @click="agregarCompetencia(competencia, categoria.nombre)" :disabled="competenciaYaSeleccionada(competencia)"
