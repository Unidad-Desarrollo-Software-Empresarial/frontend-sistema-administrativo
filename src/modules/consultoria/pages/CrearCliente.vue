<template>
  <DashboardLayout>
    <div class="p-6">
      <h2 class="text-2xl text-center font-bold max-w-md mx-auto p-4 bg-white rounded shadow-md">Crear Cliente</h2>
      <form @submit.prevent="crearCliente" class="max-w-md mx-auto p-4 bg-white rounded shadow-md">
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <select
            id="tipoEmpresa"
            v-model.number="cliente.ctemp_id"
            class="border border-gray-400 p-2 w-full"
            required
          >
