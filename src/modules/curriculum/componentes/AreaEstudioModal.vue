<template>
    <div>
      <div class="mb-4">
        <label for="areas-estudio" class="block text-gray-700 text-sm font-bold mb-2">Áreas de Estudio</label>
        <div class="relative">
          ...
          <button @click="abrirModal" class="absolute right-0 top-0 mt-2 mr-2">
  ...
  // Lista de áreas de estudio disponibles (puedes modificar o cargar dinámicamente)
  const areasDisponibles = ref([
    'Abogacía / Derecho / Leyes', 'Acicultura', 'Administración Agropecuaria', 'Administración Gerencial', 'Administración Hotelera', 'Administración Pesquera', 'Administración Turística y Hotelera', 'Administración de Empresas', 'Administración y Gestión Pública', 'Aeronautica y astronautica', 'Agricultura', 'Agrimensur', 'Agronegocios', 'Agronatural', 'Ambiental', 'Antropología', 'Análisis de Sistemas', 'Aparodera Aduanal', 'Arqueología', 'Arquitectura', 'Arte', 'Asesoria Legal'
  ]);
