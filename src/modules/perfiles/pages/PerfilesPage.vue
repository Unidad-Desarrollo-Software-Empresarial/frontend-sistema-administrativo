        ...
        <div class="w-full h-full bg-white shadow-lg rounded-lg p-6">
            ...
            <div v-if="mostrarModal" class="fixed inset-0 z-50 overflow-y-auto" @click="cerrarModal">
                <div class="flex items-center justify-center min-h-screen px-4 text-center sm:block sm:p-0">
                    ...
                    <div
                        class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full md:max-w-2xl lg:max-w-3xl"
                        @click.stop>
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="text-right text-sm text-gray-500 mt-1">0 / 150</div>
                                        </div>
...
// Función para guardar los datos (puedes personalizar esta lógica)
const guardar = () => {
