        ...
        <div class="p-6 space-y-6">
            ...
            <div class="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                ...
                <button class="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                    Generar anuncio con Copilot AI
                </button>
            </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="bg-white shadow p-4 rounded-lg md:col-span-2">
                                ...
                                <div class="mb-4">
                                    <label for="nivel" class="block text-sm font-medium text-gray-700">Nivel del
                                        perfil</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="descripcion" class="mt-1 block w-full border-gray-300 rounded-md"
                                        rows="5"></textarea>
                                </div>
                            ...
                            <div class="space-y-4 flex flex-col">
                                ...
                                <div class="bg-white shadow p-4 rounded-lg">
                                    ...
                                    <div class="flex items-center mt-2">
                                        <div
                                            class="h-24 w-24 rounded-full border-4 border-yellow-500 flex items-center justify-center">
                                            <span class="text-2xl font-bold">100%</span>
                                        </div>
                                        <p class="text-gray-600 ml-4">Importante: los pesos configurados deben sumar
                                            100%.</p>
                                    </div>
                                </div>
                            </div>
